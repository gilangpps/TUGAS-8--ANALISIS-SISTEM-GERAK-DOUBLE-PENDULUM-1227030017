# -*- coding: utf-8 -*-
"""Tugas8- Analisis Sistem Gerak Double Pendulum-Gilang Pratama Putra S.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Xcm21BaS1La1_cQWcWQbXJO3lVr295c9
"""
...
# Mendefinisikan theta 1 dan theta 2 dan menyatakan fungsi waktu.
# Juga definisi turunan pertama dan kedua.
...
# Mendeklarasikan nilai x1(teta1), y1(teta1), x2(teta1,teta2), y2(teta1,teta2)
...
# Define velocity functions using lambdify
...
# Lagrange-Euler equation for theta1
LE1 = smp.diff(L, the1) - smp.diff(L, the1_d, t)
LE1 = LE1.simplify()

# Lagrange-Euler equation for theta2
...
# Substitute and simplify expressions for Lagrange-Euler equations
a = LE1.subs([
    (smp.sin(the1 - the2), the1 - the2),
    (smp.cos(the1 - the2), 1),
    (smp.cos(the1), 1),
    (smp.sin(the1), the1),
    (the1, C * smp.cos(w * t)),
